...
plot [1:][1:6] \
     "test_results/colossus_speedup.txt" using 1:(T0_colossus/$2) with l lw 3 lt 1 title "Machine A", \
     "test_results/isi-raptor03_speedup.txt" using 1:(T0_raptor/$2) with l lw 3 title "Machine B", \
     "test_results/titan_speedup.txt" using 1:(T0_titan/$2) with l lw 3 title "Machine C", \
